...
use App\Domain\Restaurante\Requests\CreateMesaRequest;
use App\Domain\Restaurante\Requests\UpdateMesaRequest;
...
class MesaController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            if ($restauranteId) {
                $mesas = $this->mesaService->obtenerPorRestaurante($restauranteId);
            } else {
