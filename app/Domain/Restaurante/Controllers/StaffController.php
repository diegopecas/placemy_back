...
use App\Domain\Restaurante\Requests\CreateStaffRequest;
use App\Domain\Restaurante\Requests\UpdateStaffRequest;
...
class StaffController extends Controller
{
    ...
    {
        try {
            $this->staffService->asignarARestaurante(
                $id,
            ...
            return response()->json([
                'success' => true,
                'message' => 'Staff asignado al restaurante exitosamente'
            ], 200);
    ...
    /**
     * Actualizar staff en restaurante
     */
    public function actualizarEnRestaurante(Request $request, int $id, int $restauranteId): JsonResponse
    {
        try {
            $this->staffService->actualizarEnRestaurante($id, $restauranteId, $request->all());
            
            return response()->json([
                'success' => true,
                'message' => 'Staff actualizado en restaurante exitosamente'
            ], 200);
    ...
    {
        try {
            $this->staffService->desasignarDeRestaurante($id, $restauranteId);
            
            return response()->json([
                'success' => true,
                'message' => 'Staff desasignado del restaurante exitosamente'
            ], 200);
